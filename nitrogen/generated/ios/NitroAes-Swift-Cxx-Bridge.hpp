...
namespace margelo::nitro::NitroAes::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<margelo::nitro::NitroAes::HybridAesNitroSpec>`.
   */
  using std__shared_ptr_margelo__nitro__NitroAes__HybridAesNitroSpec_ = std::shared_ptr<margelo::nitro::NitroAes::HybridAesNitroSpec>;
  ...
  // pragma MARK: std::weak_ptr<margelo::nitro::NitroAes::HybridAesNitroSpec>
  using std__weak_ptr_margelo__nitro__NitroAes__HybridAesNitroSpec_ = std::weak_ptr<margelo::nitro::NitroAes::HybridAesNitroSpec>;
  inline std__weak_ptr_margelo__nitro__NitroAes__HybridAesNitroSpec_ weakify_std__shared_ptr_margelo__nitro__NitroAes__HybridAesNitroSpec_(const std::shared_ptr<margelo::nitro::NitroAes::HybridAesNitroSpec>& strong) { return strong; }
