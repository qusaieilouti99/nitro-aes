...
namespace margelo::nitro::NitroAes {
  ...
  jni::local_ref<JHybridAesNitroSpec::jhybriddata> JHybridAesNitroSpec::initHybrid(jni::alias_ref<jhybridobject> jThis) {
    return makeCxxInstance(jThis);
  }

  void JHybridAesNitroSpec::registerNatives() {
    registerHybrid({
      makeNativeMethod("initHybrid", JHybridAesNitroSpec::initHybrid),
    });
  }

  size_t JHybridAesNitroSpec::getExternalMemorySize() noexcept {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::decrypt(const std::string& ciphertext, const std::string& key, const std::string& iv, Algorithms algorithm) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::decryptFile(const std::string& key, const std::string& iv, const std::string& hmacKey, const std::string& auth, const std::string& inputPath, const std::string& outputPath, double paddingSize) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::hmac256(const std::string& ciphertext, const std::string& key) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::hmac512(const std::string& ciphertext, const std::string& key) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::randomKey(double length) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::sha1(const std::string& text) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::sha256(const std::string& text) {
  ...
  std::shared_ptr<Promise<std::string>> JHybridAesNitroSpec::sha512(const std::string& text) {
