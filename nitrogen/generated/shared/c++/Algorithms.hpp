...
namespace margelo::nitro::nitroaes {
  ...
  /**
   * An enum which can be represented as a JavaScript union (Algorithms).
   */
  enum class Algorithms {
    AES_128_CBC      SWIFT_NAME(aes128Cbc) = 0,
    AES_192_CBC      SWIFT_NAME(aes192Cbc) = 1,
    AES_256_CBC      SWIFT_NAME(aes256Cbc) = 2,
  } CLOSED_ENUM;
...
namespace margelo::nitro {
  ...
  struct JSIConverter<margelo::nitro::nitroaes::Algorithms> final {
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      switch (hashString(unionValue.c_str(), unionValue.size())) {
        case hashString("aes-128-cbc"):
        case hashString("aes-192-cbc"):
        case hashString("aes-256-cbc"):
          return true;
        default:
          return false;
      }
